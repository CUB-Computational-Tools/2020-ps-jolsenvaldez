...
insol91.jun_dec <- rename(insol91.jun_dec, June_90N = X90NJune)
insol91.jun_dec <- rename(insol91.jun_dec, June_60N = X60NJune)
insol91.jun_dec <- rename(insol91.jun_dec, June_30N = X30NJune)
insol91.jun_dec <- rename(insol91.jun_dec, June_0 = X0June)
insol91.jun_dec <- rename(insol91.jun_dec, June_30S = X30SJune)
insol91.jun_dec <- rename(insol91.jun_dec, June_60S = X60SJune)
insol91.jun_dec <- rename(insol91.jun_dec, June_90S = X90SJune)
insol91.jun_dec <- rename(insol91.jun_dec, Dec_90N = X90NDec)
insol91.jun_dec <- rename(insol91.jun_dec, Dec_60N = X60NDec)
insol91.jun_dec <- rename(insol91.jun_dec, Dec_30N = X30NDec)
insol91.jun_dec <- rename(insol91.jun_dec, Dec_0 = X0.Dec)
insol91.jun_dec <- rename(insol91.jun_dec, Dec_30S = X30SDec)
insol91.jun_dec <- rename(insol91.jun_dec, Dec_60S = X60SDec)
insol91.jun_dec <- rename(insol91.jun_dec, Dec_90S = X90SDec)

head(insol91.jun_dec)
```


```{r plot summmer (June) solstice at 30N}
plot.jun_30N <- ggplot(insol91.jun_dec, aes(x = Time, y=June_30N)) +
...
Fix function, add code line comments
```{r}
make_plot <- function(x, y, insol91.jun_dec) { #Creating a plotting function; defining x, y, and data frame  
  ggplot2::ggplot(data = insol91.jun_dec, aes(x={{ x }}, y= {{ y }})) + 
  labs(x = "Time before present (kyr)", y = paste("Insolation (W/m^2) at", toString(y))) +
  geom_point(aes(x = Time, y = y), size = 0.5, shape = 19, color = "red") +
  scale_x_reverse() +
  theme_bw() 
}
